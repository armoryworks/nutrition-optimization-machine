...
| N-69 | Perf | Med | Warm cell "Surprise me" still ~4-5 s after N-52: HouseholdRestrictionResolver ran one ILIKE seq-scan per criterion pattern (62 for this household) over the 236k-row catalog | Fixed (v0.3.45 — pg_trgm GIN index on Ingredient.Name; measured 62 patterns in 82 ms on prod. A combined-regex attempt in v0.3.43 made it 20 s and is reverted — collection/regex forms defeat the index) |
