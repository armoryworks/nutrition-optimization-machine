...
namespace Nom.Api.Controllers
{
    ...
    public class RecipeSearchController : BaseApiController
    {
        ...
        [HttpGet("random")]
        [ProducesResponseType(typeof(RecipeSearchResponseModel), StatusCodes.Status200OK)]
        public async Task<IActionResult> GetRandomRecipes([Range(1, 50)] int count = 1, long? householdId = null, int? minCalories = null, int? maxCalories = null, long? recipeTypeId = null, long? mealTypeId = null)
        {
            ...
            var results = await _searchOrchestrationService.GetRandomRecipesAsync(count, householdId, minCalories, maxCalories, recipeTypeId, mealTypeId);
            return Ok(results);
        }
