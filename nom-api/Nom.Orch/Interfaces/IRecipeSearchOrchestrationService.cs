...
namespace Nom.Orch.Interfaces
{
    public interface IRecipeSearchOrchestrationService
    {
        ...
        Task<RecipeSearchResponseModel> GetRandomRecipesAsync(int count = 1, long? householdId = null, int? minCalories = null, int? maxCalories = null, long? recipeTypeId = null, long? mealTypeId = null);
